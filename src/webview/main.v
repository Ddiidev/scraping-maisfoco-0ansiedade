...
const scripts = {
	...
	'scraping_livros_gratuitos': $embed_file('./scripts_js/scrapPageLivrosGratuitos.js')
}
...
fn run_webview(url string, file_script string) ! {
	...
	w.set_title('${file_script} scraping')
	...
	w.bind('scrapedLivrosGratuitos', scraped_livros_gratuitos)
	w.navigate(url)
...
fn scraped_livros_gratuitos(e &Event) voidptr {
	arg := e.get_arg[string](0) or { exit(1) }
